...
export function createApp() {
  ...
  app.use(cors({ origin: origins, credentials: true, methods: ['GET', 'POST', 'PUT', 'PATCH', 'OPTIONS'], allowedHeaders: ['Content-Type', 'Authorization', 'X-Blazemap-Expected-Updated-At', 'X-Blazemap-Audit-Reason'], exposedHeaders: ['Retry-After', 'X-Retry-After'] }));
