export function citationSources(value: unknown) {
  ...
  const fields = ['kind', 'observedAt', 'provider', 'attribution', 'measurementType', 'issuedAt', 'validAt', 'fetchedAt', 'name', 'sourceId', 'sourceDate', 'importedAt', 'relationBasis', 'distanceMeters', 'downwind', 'forecastId', 'subjectType', 'condition', 'windSpeed', 'windSpeedUnit', 'windFromDegrees', 'windToDegrees'];
