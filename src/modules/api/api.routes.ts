...
router.get('/admin/cases/:id', single((req, res) => { res.setHeader('Cache-Control', 'private, no-store'); return admin.getCase(routeId(req)); }));
...
router.post('/admin/teams', single((req, res) => admin.createTeam(res.locals.actor as Actor, req.body), 201));
router.post('/admin/equipment', single((req, res) => admin.createEquipment(res.locals.actor as Actor, req.body), 201));
router.post('/admin/operational-updates', single((req, res) => admin.addOperationalUpdate(res.locals.actor as Actor, req.body), 201));
